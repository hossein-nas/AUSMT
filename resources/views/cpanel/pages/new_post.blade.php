    ...
    <div class="form-group">
        <form >
            ...
            <div class="checkbox block">
                <label for="radiobtn"><input type="checkbox" name="hot_news"> آیا خبر مهم ای است؟ </label>
            </div>
            <div class="checkbox block sep">
                <label for="radiobtn"><input type="checkbox" name="slideshow">به اسلاید شو اضافه شود؟ </label>
            </div>
            <button type="submit" class="btn btn-flat-green btn-large float-left btn-wide" id="submit">ثبت خبر</button>
        </form>
    </div>
@endsection
