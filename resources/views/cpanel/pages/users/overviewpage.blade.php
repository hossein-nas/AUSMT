        ...
        <table class="userTable">
            ...
            @foreach($allUsers as $user)
                <tr>
                    ...
                    <td>{{ConvertNumbers($jalali->forge($user->created_at->timestamp)->format("%e %B %y - %H:%M"))}}</td>
                    <td>{{ConvertNumbers($jalali->forge($user->updated_at->timestamp)->format("%e %B %y - %H:%M"))}}</td>
                </tr>
            @endforeach
        </table>
