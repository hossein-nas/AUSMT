...
@if($allPosts['post']->count())
    @foreach($allPosts['post'] as $post)
        <div class="spec-post-table">
            <section class="first-section">
                <a href="/post/{{$post->hifen_title}}" target="_blank">{{$post->title}}</a>
                <section class="setting">
                    <ul>
                        <li ><a href="/post/{{$post->hifen_title}}" target="_blank" class="fa-external-link" title="مشاهده خبر"></a></li>
                        <li ><a href="/admin-panel/hide/{{$post->hifen_title}}/post" class="fa-lock "  title="مخفی کردن"></a ></li>
                        <li ><a href="/admin-panel/edit/{{$post->hifen_title}}/post" class="fa-pencil-square "  title="ویرایش خبر"></a></li>
                        <li ><a href="/admin-panel/delete/{{$post->hifen_title}}/post" class="fa-trash"  title="حذف خبر"></a></li>
                    </ul>
                </section>
            </section>
    ...
    @endforeach
@else
    <span class="noText">محتوایی برای نمایش وجود ندارد.</span>
@endif
